...
export const Designer = () => {
  ...
  return (
    <span className="padding">
      ...
      <IconButton icon="Check" label="secondary" size="s" variant="secondary" />
      <IconButton icon="Check" label="secontary" size="m" variant="secondary" />
      <IconButton icon="Check" label="secondary" size="l" variant="secondary" />
